...
export async function prepareContracts(sources: StringMap, addresses: StringMap, provider: Provider): Promise<Prepared> {
...
async function addContracts(config: TruffleConfig, sources: StringMap = {}): Promise<void> {
  let promises = [];
...
async function setUpENS(config: TruffleConfig, addresses: StringMap, from: string): Promise<string> {
